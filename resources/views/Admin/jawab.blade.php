            ...
            <div class="card">
                ...
                <div class="row row-bordered g-0">
                    <div class="card-body">
                        ...
                        <form action="{{route('insertRespon')}}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-message">Respon Aduan</label>
                                <div class="col-sm-10">
                                    <input type="text" hidden value="{{ $data->id }}" name="id_masyarakat">
                                    <textarea id="basic-default-message" required name="respon" class="form-control"
                                        placeholder="Hi, Do you have a moment to talk Joe?" aria-label="Hi, Do you have a moment to talk Joe?"
                                        aria-describedby="basic-icon-default-message2" style="height: 150px"></textarea>
                                </div>
                            </div>
